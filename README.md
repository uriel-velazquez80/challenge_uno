...
El análisis se centra en cinco áreas clave para entender el desempeño de cada tienda:

    Facturación Total: Determinar la tienda más y menos rentable.

    Ventas por Categoría: Identificar el Top 5 de categorías más populares en cada ubicación.

    Calificación Promedio: Medir la satisfacción del cliente en cada tienda.

    Productos Vendidos: Analizar los productos de mayor y menor rotación (tendencias de inventario).

    Costo de Envío: Comparar la eficiencia operativa a través del costo promedio de envío.
